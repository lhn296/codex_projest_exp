...
基于 `ESP-IDF 5.5.3` 的 ESP32-S3 学习工程，用来完成 `I2C + XL9555` 板载输入输出练习，并继续复用现有统一事件架构。
...
- 当前版本：`v1.3.1`
- 目标芯片：`ESP32-S3`
- 当前阶段：`v1.3.1 XL9555 Board Interaction`
...
7. 观察串口日志，确认能看到按键名称、手势类型、LED 或蜂鸣器业务处理过程。
